...
const secondButton = document.getElementById("change-color");
...
function changeBackgroundColor(event) {
  ...
  // firstParagraph.style.backgroundColor = "aquamarine";
  firstParagraph.classList.add("change-background-color");
}
